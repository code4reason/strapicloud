...
export interface ApiAreaArea extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areadata: Schema.Attribute.JSON;
...
export interface ApiHyttetomtHyttetomt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Areal: Schema.Attribute.Decimal;
    ...
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tomte_status: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiKommuneKommune extends Struct.CollectionTypeSchema {
...
export interface ApiNameName extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    beskrivelse: Schema.Attribute.RichText;
    Bilde: Schema.Attribute.Component<'bilde.link', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FORKLARING: Schema.Attribute.Text;
    HISTORIE: Schema.Attribute.Text;
    kommune: Schema.Attribute.Relation<'oneToOne', 'api::kommune.kommune'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::name.name'> &
      Schema.Attribute.Private;
    lond_lat: Schema.Attribute.Float;
    lond_long: Schema.Attribute.Float;
    Navn: Schema.Attribute.String;
    ny_type: Schema.Attribute.Relation<'oneToOne', 'api::type.type'>;
    publishedAt: Schema.Attribute.DateTime;
    Status: Schema.Attribute.Enumeration<['Kladd', 'Godkjent']>;
...
export interface ApiOppgaveOppgave extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dugnad: Schema.Attribute.Boolean;
    estiimat_beskrivelse: Schema.Attribute.Text;
    estimert_kostnad: Schema.Attribute.Integer;
    ferdig: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::oppgave.oppgave'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    planlagt: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTomteStatusTomteStatus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Beskrivelse: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiVariableVariable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wanip: Schema.Attribute.JSON;
    webcam: Schema.Attribute.Media<'images' | 'videos'>;
  };
}
